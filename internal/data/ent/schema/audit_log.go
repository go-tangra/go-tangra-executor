...
// Stores audit logs for Executor operations with cryptographic integrity.
...
func (AuditLog) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.Annotation{Table: "executor_audit_logs"},
...
func (AuditLog) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("tenant_id").StorageKey("executor_auditlog_tenant_id"),
		index.Fields("tenant_id", "client_id").StorageKey("executor_auditlog_tenant_client"),
		index.Fields("tenant_id", "operation").StorageKey("executor_auditlog_tenant_operation"),
		index.Fields("tenant_id", "success").StorageKey("executor_auditlog_tenant_success"),
		index.Fields("operation").StorageKey("executor_auditlog_operation"),
		index.Fields("client_id").StorageKey("executor_auditlog_client_id"),
		index.Fields("success").StorageKey("executor_auditlog_success"),
		index.Fields("peer_address").StorageKey("executor_auditlog_peer_address"),
	}
}
