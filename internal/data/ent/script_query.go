...
func (_q *ScriptQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ScriptQuery) FirstIDX(ctx context.Context) string {
...
func (_q *ScriptQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ScriptQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *ScriptQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *ScriptQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ScriptQuery) prepareQuery(ctx context.Context) error {
	...
	if script.Policy == nil {
		return errors.New("ent: uninitialized script.Policy (forgotten import ent/runtime?)")
	}
	if err := script.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *ScriptQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(script.Table, script.Columns, sqlgraph.NewFieldSpec(script.FieldID, field.TypeString))
	_spec.From = _q.sql
...
func (_q *ScriptQuery) ForUpdate(opts ...sql.LockOption) *ScriptQuery {
...
func (_q *ScriptQuery) ForShare(opts ...sql.LockOption) *ScriptQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
func (_q *ScriptQuery) Modify(modifiers ...func(s *sql.Selector)) *ScriptSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *ScriptSelect) Modify(modifiers ...func(s *sql.Selector)) *ScriptSelect {
